...
if ($_POST) {
    if (isset($_POST['salvar'])) {
        if ((isset($_POST['cod_sala']))) {
            ...
            require_once './Class/Arduino.php';
...
// resgata variáveis do formulário
            ...
            ?>
<h1 class="center-align">Acionamento Programado</h1>
<h3 class="center-align">Selecione os Equipamentos</h3>
<?php
            foreach ($daoEqi->querySeleciona3($equipamento->getCod_sala()) as $value) {
                ...
                <div class="center-align">      
                    <p style="text-align: justify;">
                         <input type="checkbox" class="filled-in" name="porta[]" id="portas" value="<?= $value['nome_Porta'] ?>">
                <label for="portas"><?= $value['nome'] ?></label>
</p>                    
                         
            <?php } ?>
<p style="text-align: justify;">
                <input type="checkbox" class="filled-in" id="porta" name="porta[]" value="todos Equipamentos" onclick="marcarTo(this.checked);">
                <label for="porta">Marcar todos</label>

</p></div>
                <script type="text/javascript">
                    function marcarTo(marcar) {
                        var itens = document.getElementsByName('porta[]');

                        if (marcar) {
                            document.getElementById('porta').innerHTML = 'Desmarcar Todos';
                        } else {
                            document.getElementById('porta').innerHTML = 'Marcar Todos';
                        }
...
<h3 class="center-align">Escolha o Professor e o Periodo</h3>             
<div class="row">
